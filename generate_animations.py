    ...
    try:
        ...
        style_elem.text = """
            path {
                ...
                stroke: #2d3436;
                fill: transparent;
                animation: draw_and_fill 3.5s cubic-bezier(0.4, 0, 0.2, 1) forwards;
            }
            
            /* Bir-biriga ulanib harakat qilishi uchun xuddi web dagi delay larni (Stagger) yasaymiz */
            path:nth-child(1n) { animation-delay: 0.1s; }
            path:nth-child(2n) { animation-delay: 0.3s; }
            path:nth-child(3n) { animation-delay: 0.5s; }
            path:nth-child(4n) { animation-delay: 0.2s; }
            path:nth-child(5n) { animation-delay: 0.4s; }
